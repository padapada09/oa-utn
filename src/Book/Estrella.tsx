...
const Estrella = ({color_value, filled} : StarProps) => {

    const color = `hsl(${23 + 37*color_value}, ${40 + 70*color_value}%, 49%)`;

    return (
        <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 477.899 477.899" width={30} height={30} style={{marginLeft: 5}}>
            <g>
                <g>
                    {   filled ?
                            <path 
